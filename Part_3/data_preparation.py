...
def charge_sortie(T, fichier_sortie, input_col, index_col = None):
    ...
    # Charge données
    #temp = pd.read_csv(fichier_sortie, sep=';')
...
#  @param T: dataframe des variables explicatives discretes
#  @param Y: dataframe de la sortie
#  @param R_dico: dictionnaire regroupant les R des variables explicatives
#  @param  verbose: afficher ou pas l'avancee de la fonction
#  @param method : méthode, vaut régression si regression sur TDC ou Cramer 
#  @param R_min : Valeur minimale de la corellation
#  @return F: dataframe transformé
...
#  @brief Cette fonction traite les colonnes continues en identifiant les variables assez corrélés avec le Y à retenir dans la suite de l'algorithme
#  @date 17 Octobre 2017
#  @details Elle crée deux sorties : Un dataframe transformé et un dictionnaire regroupant les corellations des variables
#  @param E: dataframe des variables explicatives quantitatives
#  @param Y: dataframe de la sortie
#  @param R_dico: dictionnaire regroupant les R des variables explicatives
#  @param  verbose: afficher ou pas l'avancee de la fonction
#  @param method: methode pour effectuer la selection des variables
#  @param R_cont_y: R minimum pour les variables continues
#  @param R_Cramer_y: R minimum pour les variables discretes
#  @return E: dataframe transformé
#  @return R_dico: dictionnaire regroupant les R des variables explicatives
#
#  __________________________________________________________________________________________________
...
## Calcul des groupes de variables corellées entre elles
...
#  @param T: tableau des variables explicatives
#  @param R_dico: dictionnaire regroupant les R des variables explicatives
#  @param seuil_cramer: seuil à partir du quel des varaibles discretes sont considérées comme corrélées
#  @param seuil_corr: seuil à partir du quel des varaibles continues sont considérées comme corrélées
#  @return correlation_tb: tableau des groupes de variables correllées
#
#  __________________________________________________________________________________________________
...
#  @brief Les variables continues sont normalisé et pondérées par leur coefficient de corellation
#  @date 17 Octobre 2017
#  @details 
#  @param E: dataframe des colonnes à normaliser
#  @param R_dico: dictionnaire regroupant les R des variables explicatives
#  @return E: dataframe normalisé
#
#  __________________________________________________________________________________________________
...
def main(fichier = 'variables_explicatives.csv',fichier_sortie = 'zz.csv', method_disc='regression',method_continuous='regression',
            ...
            normalize = True, verbose = True, path_rslt='chemin_vers_donnees'):

    ######################################
    #Delete all file in the folder result#
    ######################################
    print('Delete all file in the folder result')
    path_del=path_rslt + "*"
    ...
    Y = charge_sortie(T = T, fichier_sortie = fichier_sortie,
                      input_col = 'revenu', index_col = 'IDCLI_CALCULE')#'revenu_client_new.csv',
