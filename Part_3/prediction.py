## @package cabp.rfr
#  Module de calcul de la prédiction
#  @author Ilyas
#  @version 0.1
...
#  
#  @date Date de création : 24 Octobre 2017
#  @date Date de modification : 24 Octobre 2017
...
def IC_reg(repartition, dfX, Y,path_rslt):
    ...
    for j in repartition.keys():
        ...
        index = float(df_cluster["revenu"].index[~df_cluster["revenu"].apply(np.isnan)])
    ...
    result_test.to_excel(path_rslt+"result_test.xlsx",encoding="utf-8", index=True)
    result.to_excel(path_rslt+"result.xlsx",encoding="utf-8", index=True)
    return result,result_test

    

## Documentation de la fonction de calcul de la matrice de confusion et sortie des résultats
#  @brief Fonction get_score_classification
#  @details Calcul de la matrice de confusion et sortie des résultats
#  
#  @date Date de création : 24 Octobre 2017
#  @date Date de modification : 24 Octobre 2017
#  @param Y_real : Valeur réelle de la variable à expliquer
#  @param Y_pred : Valeur prédite de la variable à expliquer
#  @param threshold_pred :  Seuil de prédiction
#  @param threshold_rich :  Seuil 
#  @return confusion_matrix_ : Restitution de la matrice de confusion
#
...
## Documentation de la fonction de restitution graphique des résultats
...
#  @param Y_pred : Valeur prédite de la variable à expliquer
#  @param col : couleur
#  @param threshold_rich :  
#  @return a,b : Restitution graphique des résultats
#
...
## Documentation de la fonction de restitution graphique du revenu en fonction des variables explicatives
#  @brief Fonction graph_variable_influence
#  @details Revenu réel et prédit en fonction des variables explicatives
#  
#  @date Date de création : 24 Octobre 2017
#  @date Date de modification : 24 Octobre 2017
#  @param dfX : Les variables explicatives
#  @param result : La variable à expliquer
#  @param col : couleur
#  @return  Restitution graphique des résultats
#
#  Fonction de restitution graphique du revenu en fonction des variables explicatives
...
## Documentation de la fonction de restitution de l'erreur absolue et relative de la modélisation
#  @brief Fonction get_regression_score
#  @details 
#  
#  @date Date de création : 24 Octobre 2017
#  @date Date de modification : 24 Octobre 2017
#  @param Y_real : Le revenu réel
#  @param Y_pred : Le revenu prédit
#  @return error_abs : Erreur absolue
#  @return error_rel : Erreur relative
#
...
## Documentation de la fonction de restitution graphique de l'estimation du revenu vs revenu reel
#  @brief Fonction regression_graph
#  @details  
#  
#  @date Date de création : 24 Octobre 2017
#  @date Date de modification : 24 Octobre 2017
